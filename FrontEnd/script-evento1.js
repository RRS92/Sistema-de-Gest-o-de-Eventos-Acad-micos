        ...
        fetch("http://localhost:8080/eventos", {
            ...
            .then((response) => {
                if (response.ok) {
                    ...
                    window.location.href = "lista-evento1.html";
...
function exibirEventos(eventos) {
    ...
    eventos.forEach((evento) => {
        ...
        eventCard.innerHTML = `
            ...
            <br>
            <button class="certificate-button">Criar Certificado</button>
            <button class="transport-button">Cadastrar Transporte</button>
    ...
    // Adiciona o evento de clique ao botão de criar certificado
    ...
    // Adiciona o evento de clique ao botão de criar transporte
    ...
    // Adiciona o evento de clique ao botão de avaliar evento
    document.querySelectorAll('.evaluateEvent-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            //const nomeEvento = this.closest('.event-card').querySelector(`#nome-display-${idEvento}`).textContent; // Captura o nome do evento
    ...
    // Adiciona o evento de clique ao botão de ver avaliações
...
function toggleEditAll(id) {
    ...
    const updateButton = document.getElementById(`atualizar-${id}`);
    ...
    let isEditing = updateButton.style.display === "inline";
