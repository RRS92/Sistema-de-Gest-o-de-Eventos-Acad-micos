...
function exibirAlunos(aluno) {
    ...
    eventCard.innerHTML = `
           <button class="menu-button">&#8942;</button>
            <div class="menu">
                <ul>
                    <li><a href="../Banco/lista-banco-aluno.html">Info Bancárias</a></li>
                    <li><a href="../Endereco/lista-endereco-aluno.html">Info Residenciais</a></li>
                    <li><a href="../Paticipantes/lista-matricula.html">Info Acadêmicas</a></li>
                </ul>
            </div>
